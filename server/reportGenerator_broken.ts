...
<body>
    <div class="document-header">
        ...
        <div class="company-info">
            ...
            <div>Plano: ${planType === 'free' ? 'Gratuito' : planType === 'basic' ? 'Básico' : planType === 'pro' ? 'Profissional' : 'Personalité'}</div>
        </div>
        ...
        <div style="text-align: center; margin-top: 20px;">
            <button onclick="window.print()" style="background: #667eea; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 14px;">
    ...
    ${planType === 'free' ? `
    <div class="section">
        <div class="section-title">Resumo de Conformidade (Plano Gratuito)</div>
        <p class="policy-text">
            Sua empresa possui um nível de conformidade de <strong>${compliance.overallScore}%</strong> com a LGPD.
            ${compliance.overallScore >= 80 ? 
                'Excelente adequação às exigências legais!' :
                compliance.overallScore >= 60 ?
                'Boa adequação, mas algumas melhorias são necessárias.' :
                'Requer ações imediatas para adequação às exigências da LGPD.'
            }
        </p>
        <div style="background: #f0f8ff; border: 1px solid #667eea; padding: 20px; margin: 20px 0; border-radius: 8px; text-align: center;">
            <h3 style="color: #667eea; margin-bottom: 15px;">🚀 Upgrade para Relatório Completo</h3>
            <p>Para acessar análise detalhada por áreas, plano de ação personalizado e todas as funcionalidades:</p>
            <div style="margin-top: 15px;">
                <strong>Basic:</strong> R$ 49/mês - Relatórios ilimitados<br>
                <strong>Pro:</strong> R$ 99/mês - Relatórios + Consultoria<br>
                <strong>Personalité:</strong> Sob consulta - Solução empresarial
            </div>
        </div>
    </div>
    ` : `
